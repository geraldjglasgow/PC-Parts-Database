          ...
          <!-- sidebar -->
            <div class="col-md-2">
                ...
                <div class="list-group">
                    <a href="./psu.php" class="list-group-item">Power Supplies</a>
                </div>
            </div>
          <!-- end sidebar -->
            ...
            <div class="col-md-9">
                <div class="row">
                  ...
                  $cname = $_GET['cname'];
                  $conn = get_connection();
                  $query = $conn->prepare("SELECT brand,price,maxPower,energyEfficiency,fans,weight,name FROM psu WHERE name = '$cname'");
                  try {
                  ...
                  echo '
                    <div class="col-sm-12 col-lg-12 col-md-12 text-center">
                      <div class="thumbnail">
                          <img style="width:180px; height:135px;" src="../../pictures/psu/'.$result[0][6].'.jpg" alt="'.$result[0][6].'">
                          <div class="caption">
                          <h4>'.$result[0][0].'</h4>
                          <p>$'.$result[0][1].'<br />
                          '.$result[0][2].'<br />
