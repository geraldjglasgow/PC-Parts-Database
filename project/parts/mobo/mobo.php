    ...
    <div class="row">
      ...
      <?php
        ...
        if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
          ...
          if($table == ""){
            $q = "SELECT brand,price,socket,chipset,name,type FROM mobo";
            $query = $conn->prepare($q);
          } else{
          $q = "SELECT brand,price,socket,chipset,name,type FROM mobo WHERE ";
      ...
      <div class="col-md-10">
        <div class="row">
          ...
          while($j<sizeof($result)){
            ...
            <div class="thumbnail">
            <img src="../../pictures/mobo/'.$result[$j][4].'.jpg" alt="'.$result[$j][4].'">
            <div class="caption">
            <h4>'.$result[$j][0].'</h4>
            <p>$'.$result[$j][1].'<br />
            '.$result[$j][5].' '.$result[$j][2].'<br />
            '.$result[$j][3].' chipset<br />
