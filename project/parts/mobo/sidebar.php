...
<!-- ########################################################################################### -->
<?php
$headers = array("Brand","Type","Price","Socket","Chipset","Max Memory","Memory Type","USB Ports", "PCIE Slots");
$columns = array("brand","type","price","socket","chipset","memoryCap","memoryStandard","usbPorts","PCI");
$a=0;
while($a < sizeof($headers)){
  //get fields from database
  $query = $conn->prepare("SELECT DISTINCT $columns[$a] FROM mobo WHERE $columns[$a] <> 'NULL' ORDER BY $columns[$a] ASC");
  $query->execute();
  ...
  <div class="panel panel-default">
    ...
    <div id="collapse'.$a.'" class="panel-collapse collapse">
      ...
      <form action="/PC-Parts-Database/project/parts/mobo/mobo.php" method="get">';
      $b=0;
